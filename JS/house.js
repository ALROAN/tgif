...
function allHouse() {
  ...
  function superFilter() {
    ...
    haveTable(filterM);
    // le decimos que pinte la tabla con el resultante del filter de arriba.
  }
  ...
  //     filtrateMembers = members;
  //   }
  //   for (let j = 0; j < members.length; j++) {
  //     if (checkboxValue.includes(members[j].party)) {
  //       filtrateMembers.push(members[j]);
  //     }
  //   }
  //   filterState(filtrateMembers);

  //   // let republicans = [];
  //   // let democrats = [];
  //   // let independents = [];
  //   // republicans = Array.from(members.filter(member => member.party === "R"));
  //   // democrats = Array.from(members.filter(member => member.party === "D"));
  //   // independents = Array.from(members.filter(member => member.party === "I"));

  //   // if (checkboxRepublicans.checked) {
  //   //   x = [...x, ...republicans];
  //   // }
  //   // if (checkboxDemocrats.checked) {
  //   //   x = [...x, ...democrats];
  //   // }
  //   // if (checkboxIndependents.checked) {
  //   //   x = [...x, ...independents];
  //   // }
  // }

  // function filterState(filtrateMembers) {
  //   // --------------drop-down-states----------------------------------
  //   if (uniqueStatesMenu.value === "all") {
  //     haveTable(filtrateMembers);
  //   } else {
  //     haveTable(
  //       filtrateMembers.filter(member => member.state === uniqueStatesMenu.value)
  //     );
  //   }
  // }

  function haveTable(filtrateMembers) {
    console.log(filtrateMembers);
...
function allFinds() {
  ...
  // ---------------------------------------------------------------------
  function chekUrl() {
    if (document.getElementById("leastLoyalHouse")) {
      function createSenateGlace(array) {
        let tBodyId = document.getElementById("houseGlase");
      ...
      function createLeastLoyal(array) {
        let tBody = document.getElementById("leastLoyalHouse");
        for (let i = 0; i < array.length; i++) {
          let hilera = document.createElement("tr");
      ...
      function createMostLoyal(array) {
        let tBodyId = document.getElementById("mostLoyalHouse");
        for (let i = 0; i < array.length; i++) {
          let hilera = document.createElement("tr");
          let name = document.createElement("td");
          let numberPartyVotes = document.createElement("td");
      ...
      // -------------------------------------------------------------------
    } else if (document.getElementById("leastEngagedHouse")) {
      function createSenateGlace(array) {
        let tBodyId = document.getElementById("houseGlase");
        let hilera1 = document.createElement("tr");
        let hilera2 = document.createElement("tr");
      ...
      function createLeastEngaged(array) {
        let tBodyId = document.getElementById("leastEngagedHouse");
        for (let i = 0; i < array.length; i++) {
          let hilera = document.createElement("tr");
          let name = document.createElement("td");
      ...
      function createMostEngaged(array) {
        let tBodyId = document.getElementById("mostEngagedHouse");
        for (let i = 0; i < array.length; i++) {
          let hilera = document.createElement("tr");
          let name = document.createElement("td");
          let missedVotes = document.createElement("td");
