function AllTgif() {
  if (
    document.getElementById("senateAttendanceLoyalty") ||
    document.getElementById("senateStarter")
  ) {
    allSenatePages();
  } else if (
    document.getElementById("houseStarterPage") ||
...
function allHousePages() {
  ...
  // TREU EL LOADER DEL HTML QUAN ARRIBA EL PETCH----------------
  function hideLoader() {
    document.getElementById("loader").style.display = "none";
  }
  // HOUSE STARTER PAGE-------------------------------------------
  function HouseStarter() {
    function dropDown() {
    ...
    function superFilter() {
      ...
      if (filterM.length != 0) {
        buildTable(filterM);
        document.getElementById("noPoliticsMessage").style.visibility =
          "hidden";
  ...
  // HOUSE ATTENDANCE I HOUSE LOYALTY------------------------------
  function houseAttendanceLoyalty() {
...
function allSenatePages() {
  ...
  fetch("https://api.propublica.org/congress/v1/113/senate/members.json", {
    ...
    .then(function(datos) {
      ...
      if (document.getElementById("senateAttendanceLoyalty")) {
        SenateAttendanceLoyalty();
  ...
  // SENATE ATTENDANCE I SENATE LOYALTY------------------------
  function SenateAttendanceLoyalty() {
    let statistics = {
      numberOfDemocrats: 0,
      numberOfRepublicans: 0,
      numberOfIndependents: 0,
